...
<div class="mb-3">
    <dl style="display: flex;flex-wrap: wrap; margin-top: 60px; margin-bottom: 1rem;">
        ...
        <div class="mb-3">
            <dl style="display: flex;flex-wrap: wrap; margin-top: 60px; margin-bottom: 1rem;">
                ...
                <dd style=" width: 70%;"><input type="text" name="title" class="form-control" placeholder="授業名"></dd>
                @error('title')
        ...
        <div class="mb-3">
            <dl style="display: flex;flex-wrap: wrap; margin-top: 60px; margin-bottom: 1rem;">
                ...
                <dd style=" width: 70%;"><input type="text" name="video_url" class="form-control" placeholder="動画URL"></dd>
                @error('title')
        ...
        <div class="mb-3">
            <dl style="display: flex;flex-wrap: wrap; margin-bottom: 1rem;">
                ...
                <dd style=" width: 70%;"><textarea class="form-control" style="height:100px" name="description" placeholder="授業概要"></textarea></dd>
                @error('description')
    ...
    <div class="mb-3">
        <dl style="display: flex;flex-wrap: wrap; margin-bottom: 1rem;">
            <dt style=" width: 30%;"><label for="alway_delivery_flg" class="form-label">常時公開フラグ</label></dt>
            <dd style=" width: 70%;"><input type="checkbox" name="alway_delivery_flg" id="alway_delivery_flg" value="1"></dd>
        </dl>
    </div>
